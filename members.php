            ...
            <table class="striped highlight bordered white">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['glevel']; ?></td>
                        <td><?php if($row['status'] == 4){echo '<span class="red-text">Blocked..!</span>';}else{echo'Smashing..!';} ?></td>
                        <td><a href="unblock.php?email=<?php echo $row['fbToken']; ?>">
                            <i class="material-icons green-text">check</i>
                        </a>
                        <a href="unblock1.php?email=<?php echo $row['fbToken']; ?>">
                            <i class="material-icons blue-text">block</i>
                        </a>
                        <a href="delete1.php?email=<?php echo $row['fbToken']; ?>">
